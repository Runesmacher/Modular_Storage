...
data:extend({
  {
    ...
    minable = {hardness = 0.2, mining_time = 0.5, result = "modular-storage-controller"},
    max_health = 200,
  ...
  },
  {
    ...
    minable = {mining_time = 0.1, result = "modular-storage-stockpileTile"},
    max_health = 200,
    corpse = "small-remnants",
  ...
  },
{
    ...
    icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.3, result = "modular-storage-output"},
    max_health = 50,
    corpse = "small-remnants",
    resistances = 
    {
  ...
  },
  {
    ...
    icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.1, result = "modular-storage-input"},
    max_health = 50,
    corpse = "small-remnants",
    resistances = 
    {
  ...
  },
  {
    ...
    icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {mining_time = 1, result = "modular-storage-interface"},
    max_health = 200,
    corpse = "small-remnants",
  ...
  },
  {
    ...
    icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "modular-storage-inventory-panel"},
    max_health = 50,
    corpse = "small-remnants",
    collision_box = {{-0.35, -0.35}, {0.35, 0.35}},
    selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
